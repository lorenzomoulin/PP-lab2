...
#ifndef _RPCBLOCK_H_RPCGEN
#define _RPCBLOCK_H_RPCGEN
...
extern  int * submitchallenge_100(int *, CLIENT *);
extern  int * submitchallenge_100_svc(int *, struct svc_req *);
#define GETWINNER 5
